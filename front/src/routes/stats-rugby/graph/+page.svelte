...
<script>
    ...
    let DATAAPI1 = "/stats-rugby/data1";
    let DATAAPI2 = "/stats-rugby/data2";
    if(dev){
        DATAAPI1="http://localhost:10000/stats-rugby/data1";
        DATAAPI2="http://localhost:10000/stats-rugby/data2";
    }
